...
export const RightsModal: React.FC = memo(() => {
    ...
    return (<RightsModalUI allRights={allRights} rights={rights} idUser={idUser} name={name}/>);
})

const RightsModalUI: React.FC<PropsType> = memo(({allRights, name, rights, idUser}) => {
    const dispatch = useDispatch();
