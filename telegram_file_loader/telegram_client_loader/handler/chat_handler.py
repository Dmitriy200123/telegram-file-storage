...
class ChatHandler:
    ...
    def run(self):
        ...
        self.telegram_client.add_event_handler(self.__handle_chat_event, chat_event)
        self.telegram_client.add_event_handler(self.__handle_migrate_chat_event, chat_migrate_event)
